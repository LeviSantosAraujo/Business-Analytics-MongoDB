"""
Vercel Python Template - Standard approach for Business Analytics Dashboard
"""
import json
...
def index():
    ...
    try:
        ...
        # Replace hardcoded localhost URL with dynamic one
        html_content = html_content.replace('http://localhost:5000/api', api_base)
